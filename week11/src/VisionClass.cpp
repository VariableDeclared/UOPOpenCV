...
namespace ComputerVision 
{
    ...
    SquareImage::SquareImage(String imageDirectory, String displayString, MouseCallback callback) {
    ...
    void SquareImage::setupWindow(int windowFlag) {
    ...
    void SquareImage::rotateImage(int deg) {
